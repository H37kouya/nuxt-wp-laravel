...
const routes = [
  { path: '/', name: 'welcome', component: page('welcome.vue') },
  {
    path: '/complete',
    name: 'complete',
    component: page('contact/complete.vue')
  },
  {
    path: '/articles',
    name: 'articles.index',
  ...
  },
  {
    path: '/articles/:slug',
    name: 'articles',
    component: page('articles/_slug.vue')
  },
  {
    path: '/category/:slug',
    name: 'category',
    component: page('category/_slug.vue')
  },
  {
    path: '/tag/:slug',
    name: 'tag',
    component: page('tag/_slug.vue')
  }
  // 今はログイン機能はいらないためコメントアウト
